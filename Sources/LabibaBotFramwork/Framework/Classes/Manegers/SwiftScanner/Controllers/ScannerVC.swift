...
extension ScannerVC{
    ...
    func setupUI() {
     ...
     func setupScanner(_ title:String? = nil, _ color:UIColor? = nil, _ style:ScanAnimationStyle? = nil, _ tips:String? = nil, success:@escaping ((String)->()), failer:@escaping ((scanningError)->())){
...
extension ScannerVC:CameraViewControllerDelegate{
    ...
    func didReceiveError(_ error: scanningError) {
