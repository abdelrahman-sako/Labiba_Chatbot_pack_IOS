//
//  RatingSatrsLightCell.swift
//  LabibaBotFramwork
//
//  Created by Abdulrahman Qasem on 12/14/20.
//  Copyright © 2020 Abdul Rahman. All rights reserved.
//

import UIKit

class RatingSatrsLightCell: RatingCell {
    ...
    override func awakeFromNib() {
        ...
        starsContainerView.layer.borderWidth = 1
        starsContainerView.layer.borderColor = Labiba.RatingForm.starsContainerBorderColor.cgColor
