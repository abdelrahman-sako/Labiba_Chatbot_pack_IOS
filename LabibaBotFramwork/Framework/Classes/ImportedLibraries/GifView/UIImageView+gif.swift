...
extension UIImageView {
    private class func gifWithData(_ data: Data, afterCreateImageView: @escaping ([UIImage], Double) -> ()) {
     ...
     class func gifWithURL(_ gifUrl: String, afterCreateImageView: @escaping ([UIImage], Double) -> ()) {
        // 校验URL
    ...
    // 从资源文件中获取gif数据，生成UIImageView
     class func gifWithName(_ name: String, afterCreateImageView: @escaping ([UIImage], Double) -> ()) {
        // 校验gif是否存在
